...
export const balanceCatalogV1: BalanceCatalogDto = {
  ...
  scales: [
    ...
    },
    {
      ...
      steps: [
        { levelFrom: 0, base: "1" },
        { levelFrom: 1, base: "1.16" },
        { levelFrom: 2, base: "1.32" },
        { levelFrom: 3, base: "1.5" },
        { levelFrom: 4, base: "1.7" },
        { levelFrom: 5, base: "1.92" },
      ],
    },
    ...
    },
    {
      ...
      steps: [
        { levelFrom: 0, base: "1" },
        { levelFrom: 1, base: "1.12" },
        { levelFrom: 2, base: "1.27" },
        { levelFrom: 3, base: "1.44" },
        { levelFrom: 4, base: "1.63" },
        { levelFrom: 5, base: "1.84" },
      ],
    },
    ...
    },
    {
      ...
      steps: [
        { levelFrom: 0, base: "1" },
        { levelFrom: 1, base: "1.11" },
        { levelFrom: 2, base: "1.24" },
        { levelFrom: 3, base: "1.39" },
        { levelFrom: 4, base: "1.56" },
        { levelFrom: 5, base: "1.75" },
      ],
    },
    ...
    },
    {
      ...
      steps: [
        { levelFrom: 0, base: "1" },
        { levelFrom: 1, base: "1.08" },
        { levelFrom: 2, base: "1.18" },
        { levelFrom: 3, base: "1.29" },
        { levelFrom: 4, base: "1.41" },
        { levelFrom: 5, base: "1.54" },
      ],
    },
    ...
    // Warehouses
    {
      ...
      steps: [
        ...
        { levelFrom: 2, base: "30700" },
        { levelFrom: 3, base: "41800" },
        { levelFrom: 4, base: "57700" },
        { levelFrom: 5, base: "74300" },
        { levelFrom: 6, base: "96200" },
        { levelFrom: 7, base: "125100" },
        { levelFrom: 8, base: "150700" },
      ],
    },
    {
