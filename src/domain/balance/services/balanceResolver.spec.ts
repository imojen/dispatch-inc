...
describe('BalanceResolver', () => {
  ...
  it('resolves skill and warehouse values', () => {
    ...
    expect(resolver.resolveSkillEffect('staff.mastery', 5)).toBe(50)
    expect(resolver.resolveSkillEffect('scan.mastery', 5)).toBe(12)
    expect(resolver.resolveSkillEffect('conveyor.mastery', 5)).toBe(5)
    expect(resolver.resolveSkillEffect('sorting.mastery', 5)).toBe(5)
    expect(resolver.resolveSkillEffect('shipping.mastery', 5)).toBe(6)
    expect(resolver.resolveSkillEffect('warehouse.mastery', 5)).toBe(6)
    ...
    expect(resolver.resolveWarehouseCost('warehouse.progression', 1)).toBeGreaterThan(0)
  })
})
