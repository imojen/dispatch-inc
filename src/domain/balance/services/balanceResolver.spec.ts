...
describe('BalanceResolver', () => {
  ...
  it('resolves skill and warehouse values', () => {
    ...
    expect(resolver.resolveSkillEffect('staff.mastery', 5)).toBe(7.6)
    expect(resolver.resolveSkillEffect('scan.mastery', 5)).toBe(7.6)
    expect(resolver.resolveSkillEffect('conveyor.mastery', 5)).toBe(7.6)
    expect(resolver.resolveSkillEffect('sorting.mastery', 5)).toBe(7.6)
    expect(resolver.resolveSkillEffect('shipping.mastery', 5)).toBe(7.6)
    expect(resolver.resolveSkillEffect('warehouse.mastery', 5)).toBe(7.6)
    ...
    expect(resolver.resolveWarehouseRequirement('warehouse.progression', 2)).toBe(66_000)
